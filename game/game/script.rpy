...
define s4 = Character('Первый Субару', color="#ffae00", image='subaru')
define s5 = Character('Второй Субару', color="#ffae00", image='subaru')
define s6 = Character('Третий Субару', color="#ffae00", image='subaru')
...
screen back_butt:
    ...
    fixed:
        ...
        button:
            xpos 780 ypos 715
            xsize 380 ysize 86
            idle_background "sprites/white_idle.png"
            hover_foreground "sprites/white_hover.png"

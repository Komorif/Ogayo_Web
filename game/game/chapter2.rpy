...
label chapterTwo:
    ...
    rezo "— Почему?"
    malaysia two "— Сейчас намного важнее доставить тебя к нам - Френдсоло!"
    malaysia two "— Вот, выпей."
    ...
    rezo "— Что это?"
    malaysia two "— Неважно, пей быстрее. {w}Мы не можем терять времени на болтовню."
    ...
    malaysia two "— Чувствуешь что-то?"
    rezo "— Да."
    malaysia two "— Отлично. Тогда следуй за нами."
    malaysia two "— Как выйдем на дорогу можешь бежать со всех ног."
    ...
    s3 three "— Твари. Это наша часть леса, какого лешего они здесь ходят?"
    ...
    KpPhageSquad "— Они не выходили на связь примерно 20 минут."
    ...
    malaysia two "— Хорошо, передохнём немного."
    rezo "— Сколько нам ещё бежать?"
    malaysia two "— Минут 10."
    malaysia two "— Ещё выпьешь?"

    rezo "— Пожалуй не откажусь."

    "Малазия кинул мне тот же мешок для воды."

    malaysia two "— Можешь всю выпить."
    rezo "— А как же вы?"
    malaysia two "— Мы и без этого справимся."
    malaysia two "— И не такие расстояния бежали без воды."
    ...
    s1 one "— Ага. Просто наш король сказал всем переодеться как этот Субару, а иначе он нас выселит."
    rezo "— И вы согласились на это?"
    s1 one "— Если бы это было просто ради его прихоти, то конечно же нет."
    s1 one "— Но от этого есть несколько практичных плюсов."
    rezo "— Каких?"
    s1 one "— Мы пока не так сильно тебе доверяем, чтобы рассказывать обо всём."
    rezo "— Понимаю."
    ...
    rezo "~ Пока останусь вместе с Субару, а если ситуация ухудшиться, то стану на их сторону и выставлю Субару с плохой стороны. ~"
